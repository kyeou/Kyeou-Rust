...
fn check_unstable(curr_man_id: i32, curr_woman_id: i32, matchings: Vec<i32>, mens_desire: Vec<i32>, womens_desire: Vec<i32>) -> bool {

    if currWomanID == matchings[(currManID-1) as usize] {
        return false;
    }
    return true;
}
...
println!("{:?}", check_unstable(1,3, matchings, mens_desire));
}
